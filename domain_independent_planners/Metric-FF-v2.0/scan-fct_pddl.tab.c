...
#line 1575 "scan-fct_pddl.tab.c"
    break;

  case 6:
#line 189 "scan-fct_pddl.y"
{ 
...
#line 1611 "scan-fct_pddl.tab.c"
    break;

  case 16:
#line 240 "scan-fct_pddl.y"
{
  gorig_initial_facts = new_PlNode(AND);
  gorig_initial_facts->sons = (yyvsp[-1].pPlNode);
}
#line 1620 "scan-fct_pddl.tab.c"
    break;
...
#line 1654 "scan-fct_pddl.tab.c"
    break;

  case 20:
#line 290 "scan-fct_pddl.y"
{
...
#line 1889 "scan-fct_pddl.tab.c"
    break;

  case 40:
#line 505 "scan-fct_pddl.y"
{
...
#line 1901 "scan-fct_pddl.tab.c"
    break;

  case 41:
#line 514 "scan-fct_pddl.y"
{
  (yyval.pParseExpNode) = new_ParseExpNode( MINUS );
  (yyval.pParseExpNode)->leftson = (yyvsp[-1].pParseExpNode);
}
#line 1910 "scan-fct_pddl.tab.c"
    break;

  case 42:
#line 520 "scan-fct_pddl.y"
{
...
#line 1982 "scan-fct_pddl.tab.c"
    break;

  case 49:
#line 575 "scan-fct_pddl.y"
{
  (yyval.pParseExpNode) = new_ParseExpNode( AD );
  (yyval.pParseExpNode)->leftson = (yyvsp[-2].pParseExpNode);
  (yyval.pParseExpNode)->rightson = (yyvsp[-1].pParseExpNode);
}
#line 1992 "scan-fct_pddl.tab.c"
    break;
...
#line 2117 "scan-fct_pddl.tab.c"
    break;

  case 63:
#line 691 "scan-fct_pddl.y"
{ (yyval.pTypedList) = NULL; }
#line 2123 "scan-fct_pddl.tab.c"
    break;
...
#line 2167 "scan-fct_pddl.tab.c"
    break;

  case 67:
#line 733 "scan-fct_pddl.y"
{ (yyval.pTypedList) = NULL; }
#line 2173 "scan-fct_pddl.tab.c"
    break;
...
#line 2185 "scan-fct_pddl.tab.c"
    break;

  case 69:
#line 745 "scan-fct_pddl.y"
{
  (yyval.pTypedList) = new_TypedList();
  (yyval.pTypedList)->name = new_Token( strlen((yyvsp[-3].string))+1 );
  strcpy( (yyval.pTypedList)->name, (yyvsp[-3].string) );
...
#line 2217 "scan-fct_pddl.tab.c"
    break;

  case 71:
#line 777 "scan-fct_pddl.y"
{ 
  (yyval.pstring) = new_Token(strlen((yyvsp[0].string)) + 1);
  strcpy((yyval.pstring), (yyvsp[0].string));
}
#line 2226 "scan-fct_pddl.tab.c"
    break;

  case 72:
#line 801 "scan-fct_pddl.y"
{ 
  PlNode *tmp;
...
#line 2258 "scan-fct_pddl.tab.c"
    break;

  case 75:
#line 832 "scan-fct_pddl.y"
{ (yyval.pTokenList) = NULL; }
#line 2264 "scan-fct_pddl.tab.c"
    break;
...
#line 2275 "scan-fct_pddl.tab.c"
    break;


#line 2279 "scan-fct_pddl.tab.c"
